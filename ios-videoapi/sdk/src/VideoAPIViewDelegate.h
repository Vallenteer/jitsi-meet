...
@protocol VideoAPIViewDelegate <NSObject>
 ...
 * https://github.com/jitsi/lib-VideoAPI/blob/master/JitsiConnectionErrors.js
 * https://github.com/jitsi/lib-VideoAPI/blob/master/JitsiConferenceErrors.js
 */
...
- (void)raiseHandUpdated:(NSDictionary *)data;
- (void)deviceListChanged:(NSDictionary *)data;
 ...
 * associated `VideoAPIView`. The latter will automatically detect its new size
