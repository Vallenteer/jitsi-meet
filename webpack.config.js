...
/**
 * The URL of the VideoAPI Meet deployment to be proxy to in the context of
 * development with webpack-dev-server.
 */
const devServerProxyTarget
    = process.env.WEBPACK_DEV_SERVER_PROXY_TARGET || 'https://v.videoapi.liveprod.cloud';
...
module.exports = [
    ...
    Object.assign({}, config, {
        ...
        performance: getPerformanceHints(4000 * 1024)
    }),
    Object.assign({}, config, {
        entry: {
    ...
    Object.assign({}, config, {
        ...
        output: Object.assign({}, config.output, {
            library: [ 'LibVideoAPI', 'app', 'effects' ],
    ...
    Object.assign({}, config, {
        ...
        output: Object.assign({}, config.output, {
            library: [ 'LibVideoAPI', 'app', 'effects', 'rnnoise' ],
            libraryTarget: 'window',
            filename: '[name].min.js',
            sourceMapFilename: '[name].min.map'
        }),
