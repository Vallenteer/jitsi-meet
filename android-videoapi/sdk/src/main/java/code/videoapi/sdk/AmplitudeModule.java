...
class AmplitudeModule
    ...
    public static final String VIDEOAPI_PREFERENCES = "videoapi-preferences";
    ...
    public void init(String instanceName, String apiKey) {
        ...
        SharedPreferences sharedPreferences = getReactApplicationContext().getSharedPreferences(VIDEOAPI_PREFERENCES, Context.MODE_PRIVATE);
        ...
        if (!TextUtils.isEmpty(android_id)) {
            ...
            editor.putString(VIDEOAPI_PREFERENCES, amplitudeId).apply();
        }
    }
    ...
    public void logEvent(String instanceName, String eventType, String eventPropsString) {
        try {
            ...
            VideoAPILogger.e(e, "Error logging event");
        }
    }
