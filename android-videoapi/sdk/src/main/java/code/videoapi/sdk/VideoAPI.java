...
public class VideoAPI {
    ...
    /**
     * Default {@link VideoAPIConferenceOptions} which will be used for all conferences. When
     * joining a conference these options will be merged with the ones passed to
     * {@link VideoAPIView} join().
     */
    private static VideoAPIConferenceOptions defaultConferenceOptions;

    public static VideoAPIConferenceOptions getDefaultConferenceOptions() {
        return defaultConferenceOptions;
    }

    public static void setDefaultConferenceOptions(VideoAPIConferenceOptions options) {
    ...
    public static boolean isCrashReportingDisabled(Context context) {
        SharedPreferences preferences = context.getSharedPreferences("videoapi-default-preferences", Context.MODE_PRIVATE);
    ...
    public static void showSplashScreen(Activity activity) {
        try {
            ...
            VideoAPILogger.e(e, "Failed to show splash screen");
        }
    }
}