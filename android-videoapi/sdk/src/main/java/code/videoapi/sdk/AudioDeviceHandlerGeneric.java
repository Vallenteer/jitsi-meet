...
class AudioDeviceHandlerGeneric implements
    ...
    private final Runnable onAudioDeviceChangeRunner = new Runnable() {
        ...
        public void run() {
            ...
            VideoAPILogger.i(TAG + " Available audio devices: " + devices.toString());
    ...
    private final android.media.AudioDeviceCallback audioDeviceCallback =
        new android.media.AudioDeviceCallback() {
            ...
            public void onAudioDevicesAdded(
                ...
                VideoAPILogger.d(TAG + " Audio devices added");
                onAudioDeviceChange();
            }
            ...
            public void onAudioDevicesRemoved(
                ...
                VideoAPILogger.d(TAG + " Audio devices removed");
                onAudioDeviceChange();
            }
        };
            ...
            public void run() {
                switch (focusChange) {
                    case AudioManager.AUDIOFOCUS_GAIN: {
                        VideoAPILogger.d(TAG + " Audio focus gained");
                    ...
                    case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK: {
                        VideoAPILogger.d(TAG + " Audio focus lost");
                        audioFocusLost = true;
                        break;
                    }
                }
    ...
    public void start(AudioModeModule audioModeModule) {
        VideoAPILogger.i("Using " + TAG + " as the audio device handler");
    ...
    public boolean setMode(int mode) {
        ...
        if (audioManager.requestAudioFocus(this, AudioManager.STREAM_VOICE_CALL, AudioManager.AUDIOFOCUS_GAIN)
            ...
            VideoAPILogger.w(TAG + " Audio focus request failed");
            return false;
        }
