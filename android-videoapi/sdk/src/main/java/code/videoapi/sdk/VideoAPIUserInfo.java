...
/**
 * This class represents user information to be passed to {@link VideoAPIConferenceOptions} for
 * identifying a user.
 */
public class VideoAPIUserInfo {
    /**
     * User's display name.
     */
    ...
    public VideoAPIUserInfo() {}

    public VideoAPIUserInfo(Bundle b) {
        super();
