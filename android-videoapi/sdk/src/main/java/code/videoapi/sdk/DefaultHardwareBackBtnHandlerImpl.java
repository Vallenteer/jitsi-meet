...
/**
 * Defines the default behavior of {@code VideoAPIFragment} and
 * {@code VideoAPIView} upon invoking the back button if no
 * {@code VideoAPIView} handles the invocation. For example, a
 * {@code VideoAPIView} may (1) handle the invocation of the back button
