...
/**
 * VideoAPI implementation of {@link ConnectionService}. At the time of this
...
public class ConnectionService extends android.telecom.ConnectionService {
     ...
     */
    static final String TAG = "VideoAPIConnectionService";
    ...
    static final String EXTRA_PHONE_ACCOUNT_HANDLE
        = "code.videoapi.sdk.connection_service.PHONE_ACCOUNT_HANDLE";
    ...
    static boolean setConnectionActive(String callUUID) {
        ...
        if (connection != null) {
            ...
            VideoAPILogger.w("%s setConnectionActive - no connection for UUID: %s", TAG, callUUID);
            return false;
        }
    }
    ...
    static void setConnectionDisconnected(String callUUID, DisconnectCause cause) {
        ...
        if (connection != null) {
            ...
            VideoAPILogger.e(TAG + " endCall no connection for UUID: " + callUUID);
        }
    }
    ...
    static void updateCall(String callUUID, ReadableMap callState) {
        ...
        if (connection != null) {
            if (callState.hasKey(ConnectionImpl.KEY_HAS_VIDEO)) {
                ...
                VideoAPILogger.i(" %s updateCall: %s hasVideo: %s", TAG, callUUID, hasVideo);
            ...
            VideoAPILogger.e(TAG + " updateCall no connection for UUID: " + callUUID);
        }
    }
    ...
    public Connection onCreateOutgoingConnection(
        ...
        if (startCallPromise != null) {
            VideoAPILogger.d(TAG + " onCreateOutgoingConnection " + connection.getCallUUID());
    ...
    public void onCreateOutgoingConnectionFailed(
        ...
        VideoAPILogger.e(TAG + " onCreateOutgoingConnectionFailed " + callUUID);
        ...
        if (callUUID != null) {
            ...
            if (startCallPromise != null) {
                ...
                VideoAPILogger.e(TAG + " startCallFailed - no start call Promise for UUID: " + callUUID);
            }
        } else {
            VideoAPILogger.e(TAG + " onCreateOutgoingConnectionFailed - no call UUID");
        }
    ...
    private void unregisterPhoneAccount(PhoneAccountHandle phoneAccountHandle) {
        ...
        if (telecom != null) {
            if (phoneAccountHandle != null) {
                ...
                VideoAPILogger.e(TAG + " unregisterPhoneAccount - account handle is null");
            }
        } else {
            VideoAPILogger.e(TAG + " unregisterPhoneAccount - telecom is null");
        }
    }
    ...
    /**
     * Connection implementation for VideoAPI's {@link ConnectionService}.
     *
     * @author Pawel Domas
     */
    class ConnectionImpl extends Connection {
        ...
        public void onDisconnect() {
            VideoAPILogger.i(TAG + " onDisconnect " + getCallUUID());
            WritableNativeMap data = new WritableNativeMap();
            data.putString("callUUID", getCallUUID());
            ReactInstanceManagerHolder.emitEvent(
                    "code.videoapi:features/connection_service#disconnect",
                    data);
        ...
        @Override
        public void onAbort() {
            VideoAPILogger.i(TAG + " onAbort " + getCallUUID());
            WritableNativeMap data = new WritableNativeMap();
            data.putString("callUUID", getCallUUID());
            ReactInstanceManagerHolder.emitEvent(
                    "code.videoapi:features/connection_service#abort",
                    data);
            // The JavaScript side will not go back to the native with
            // 'endCall', so the Connection must be removed immediately.
            setConnectionDisconnected(
        ...
        public void onHold() {
            ...
            // TODO implement HOLD
            VideoAPILogger.w(TAG + " onHold %s - HOLD is not supported, aborting the call...", getCallUUID());
            this.onAbort();
        }
        ...
        public void onCallAudioStateChanged(CallAudioState state) {
            VideoAPILogger.d(TAG + " onCallAudioStateChanged: " + state);
