...
class AudioDeviceHandlerConnectionService implements
    ...
    private static int audioDeviceToRouteInt(String audioDevice) {
        ...
        switch (audioDevice) {
            ...
            case AudioModeModule.DEVICE_SPEAKER:
                return CallAudioState.ROUTE_SPEAKER;
            default:
                VideoAPILogger.e(TAG + " Unsupported device name: " + audioDevice);
                return CallAudioState.ROUTE_SPEAKER;
        }
    }
    ...
    public void start(AudioModeModule audioModeModule) {
        ...
        if (rcs != null) {
            ...
            VideoAPILogger.w(TAG + " Couldn't set call audio state listener, module is null");
        }
    }
    ...
    public boolean setMode(int mode) {
        if (mode != AudioModeModule.DEFAULT) {
            ...
            try {
                ...
                VideoAPILogger.w(tr, TAG + " Failed to unmute the microphone");
            }
        }
