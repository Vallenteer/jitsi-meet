...
/**
 * Shows/hides the overflow hangup button.
 *
 * @param {boolean} hangupVisible - True to show it or false to hide it.
 * @returns {{
    *     type: SET_OVERFLOW_MENU_VISIBLE,
    *     visible: boolean
    * }}
    */
   export function setOverflowMenuHangupVisible(hangupVisible: boolean): Object {
       return {
           type: SET_OVERFLOW_HANGUP_VISIBLE,
           hangupVisible
       };
   }
