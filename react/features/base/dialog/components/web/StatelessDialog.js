...
import { Button, ButtonGroup, Modal, ModalFooter } from '../../../../videoapi/components/web';
...
class StatelessDialog extends Component<Props> {
    ...
    render() {
        ...
        return (
            <Modal
                autoFocus = { true }
                childrenStyle = { this.props.childrenStyle }
                components = {{
                    Header: customHeader
                }}
    ...
    _renderFooter(propsFromModalFooter) {
        ...
        return (
            <ModalFooter hideButtons = { this.props.hideButtons } >
                {
