...
export default class SmallVideo {
    ...
    */
    ...
    showDominantSpeakerIndicatorToolbar(showDominantSpeakerIndicator = false) {
        const statusBarContainer = this.container.querySelector('.videocontainer__toolbar');
        ...
        ReactDOM.render(
            <Provider store = { APP.store }>
                <I18nextProvider i18n = { i18next }>                    
                    <StatusIndicators
                        participantID = { this.id }
                        showDominantSpeakerIndicator = { showDominantSpeakerIndicator } />
                </I18nextProvider>
            </Provider>,
            statusBarContainer);
    }
                ...
                <I18nextProvider i18n = { i18next }>
                    <div>
                        <AtlasKitThemeProvider mode = 'dark'>
                            ...
                            {this.showDominantSpeakerIndicatorToolbar(this._showDominantSpeaker && participantCount > 2)}                           
