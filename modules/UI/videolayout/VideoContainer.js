...
function getCameraVideoPosition( // eslint-disable-line max-params
    ...
    // const horizontalIndent =  videoWidth / 8;
    // const verticalIndent =  videoHeight / 8;
...
export class VideoContainer extends LargeContainer {
     ...
     * this instance.
     */
    constructor(resizeContainer, emitter, offset) {
        super();
        this.stream = null;
        this.userId = null;
        this.videoType = null;
    ...
    resize(containerWidth, containerHeight, animate = false) {
        ...
        const shiftLeft = state['features/videoapi/modal-dialog'].isOpen || state['features/chat'].isOpen;
