...
/**
 * Saves e2e ping related state for a single VideoAPIParticipant.
 */
class ParticipantWrapper {
    /**
     * Creates a ParticipantWrapper
     * @param {VideoAPIParticipant} participant - The remote participant that this
     * object wraps.
     * @param {E2ePing} e2eping
     */
    constructor(participant, e2eping) {
        // The VideoAPIParticipant
...
export default class E2ePing {
    /**
     * @param {VideoAPIConference} conference - The conference.
    ...
    constructor(conference, options, sendMessage) {
        ...
        conference.on(
            VideoAPIConferenceEvents.DATA_CHANNEL_OPENED,
     ...
     * @param {VideoAPIParticipant} participant - The participant that joined.
     */
