...
export default class JingleSessionPC extends JingleSession {
    ...
    /**
     * Sends Jingle 'session-info' message which includes custom VideoAPI Meet
     ...
     * about the error.
     * @param {Array<VideoAPILocalTrack>} [localTracks] the optional list of
     ...
     * @param {Array<VideoAPILocalTrack>} localTracks the local tracks that will be
     ...
     * @param {VideoAPILocalTrack} track the local track to be removed
     ...
     * @param {VideoAPILocalTrack} track the track that will be added/removed
     * @private
     */
