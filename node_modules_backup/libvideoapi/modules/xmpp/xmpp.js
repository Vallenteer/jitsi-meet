    ...
    constructor(options, token) {
        ...
        this.connection.on(XmppConnection.Events.CONN_SHARD_CHANGED, () => {
            ...
            this.eventEmitter.emit(
                VideoAPIConnectionEvents.CONNECTION_FAILED,
                VideoAPIConnectionErrors.OTHER_ERROR,
                undefined,
                undefined,
                details);
        });
    ...
    connectionHandler(credentials = {}, status, msg) {
        ...
        if (status === Strophe.Status.CONNECTED || status === Strophe.Status.ATTACHED) {
                                ...
                                .then(({ features: f }) => {
                                    f.forEach(fr => {
                                        if (fr.endsWith('#displayname_required')) {
                                            this.eventEmitter.emit(
                                                VideoAPIConnectionEvents.DISPLAY_NAME_REQUIRED);
                                        }
                                    });
                                })
            ...
            if (this.connection && this.connection.connected
                ...
                this.eventEmitter.emit(
                    VideoAPIConnectionEvents.CONNECTION_ESTABLISHED,
                    Strophe.getResourceFromJid(this.connection.jid));
            }
            ...
            if (msg === 'giving-up') {
                this.eventEmitter.emit(
                    VideoAPIConnectionEvents.CONNECTION_FAILED,
                    VideoAPIConnectionErrors.OTHER_ERROR, msg);
            }
            ...
            if (this.anonymousConnectionFailed) {
                ...
                this.eventEmitter.emit(
                    VideoAPIConnectionEvents.CONNECTION_FAILED,
                    VideoAPIConnectionErrors.PASSWORD_REQUIRED);
                ...
                this.eventEmitter.emit(
                    VideoAPIConnectionEvents.CONNECTION_DISCONNECTED, errMsg);
            } else {
                ...
                if (lastErrorStatus >= 500 && lastErrorStatus < 600) {
                    this.eventEmitter.emit(
                        VideoAPIConnectionEvents.CONNECTION_FAILED,
                        VideoAPIConnectionErrors.SERVER_ERROR,
                        errMsg || 'server-error',
                    ...
                    this.eventEmitter.emit(
                        VideoAPIConnectionEvents.CONNECTION_FAILED,
                        VideoAPIConnectionErrors.CONNECTION_DROPPED_ERROR,
