...
export default class ProxyConnectionService {
     ...
     * @param {VideoAPIConnection} [options.jitsiConnection] - The
     * {@code VideoAPIConnection} which will be used to fetch TURN credentials for
     * the P2P connection.
     * @param {Function} options.onRemoteStream - Callback to invoke when a
     * remote video stream has been received and converted to a
     * {@code VideoAPILocakTrack}. The {@code VideoAPILocakTrack} will be passed in.
     ...
     * receive messages.
     * @param {Array<VideoAPILocalTrack>} localTracks - Initial media tracks to
     ...
     * {@code VideoAPILocalTrack} for local usage if the {@code onRemoteStream}
     * callback is defined.
     *
     * @param {VideoAPIRemoteTrack} jitsiRemoteTrack - The {@code VideoAPIRemoteTrack}
