...
export default class ProxyConnectionPC {
    ...
    constructor(options = {}) {
        ...
        /**
         * Instances of {@code VideoAPITrack} associated with this instance of
         * {@code ProxyConnectionPC}.
         *
         * @type {Array<VideoAPITrack>}
         */
        this._tracks = [];
     ...
     *
     * @param {Array<VideoAPILocalTrack>} localTracks - Initial local tracks to add
    ...
    _createPeerConnection() {
         ...
         * {@code VideoAPIConference}, which has an event emitter that is used
         ...
         * is instantiated outside of the {@code VideoAPIConference}, so it must be
        ...
        /**
         * A {@code VideoAPIConference} stub passed to the {@link RTC} module.
         * @type {Object}
         */
     ...
     * stream.
     *
     * @param {VideoAPIRemoteTrack} jitsiRemoteTrack - The remote media stream
     * wrapped in {@code VideoAPIRemoteTrack}.
     * @private
     * @returns {void}
     */
