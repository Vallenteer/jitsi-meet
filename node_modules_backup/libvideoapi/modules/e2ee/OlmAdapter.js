...
export class OlmAdapter extends Listenable {
    ...
    constructor(conference) {
        ...
        if (OlmAdapter.isSupported()) {
            ...
            this._conf.on(VideoAPIConferenceEvents.ENDPOINT_MESSAGE_RECEIVED, this._onEndpointMessageReceived.bind(this));
            this._conf.on(VideoAPIConferenceEvents.CONFERENCE_JOINED, this._onConferenceJoined.bind(this));
            this._conf.on(VideoAPIConferenceEvents.CONFERENCE_LEFT, this._onConferenceLeft.bind(this));
            this._conf.on(VideoAPIConferenceEvents.USER_LEFT, this._onParticipantLeft.bind(this));
        } else {
     ...
     *
     * @param {VideoAPIParticipant} participant - Participant whose data wants to be extracted.
     * @returns {Object}
     * @private
     */
     ...
     *
     * @param {VideoAPIParticipant} participant - The target participant.
     ...
     *
     * @param {VideoAPIParticipant} participant - Participant to whom we'll send the request.
