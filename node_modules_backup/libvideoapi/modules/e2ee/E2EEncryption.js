...
/**
 * This module integrates {@link E2EEContext} with {@link VideoAPIConference} in order to enable E2E encryption.
 */
export class E2EEncryption {
    /**
     * A constructor.
     * @param {VideoAPIConference} conference - The conference instance for which E2E encryption is to be enabled.
     */
    constructor(conference) {
        ...
        this.conference.on(
            VideoAPIConferenceEvents.TRACK_MUTE_CHANGED,
     ...
     * @param {VideoAPILocalTrack} track - the new track that's being added to the conference.
     * @private
     */
     ...
     * @param {VideoAPILocalTrack} track - the local track for which e2e encoder will be configured.
     * @private
     */
     ...
     * @param {VideoAPILocalTrack} track - the track for which muted status has changed.
     * @private
     */
