...
class MockConference extends Listenable {
    ...
    addMediaSession(mediaSession) {
        ...
        this.eventEmitter.emit(VideoAPIConferenceEvents._MEDIA_SESSION_STARTED, mediaSession);
    }
    ...
    setActiveMediaSession(mediaSession) {
        ...
        this.eventEmitter.emit(VideoAPIConferenceEvents._MEDIA_SESSION_ACTIVE_CHANGED, this.activeMediaSession);
    }
