 ...
 * {@link VideoAPIConference}. It finds the lowest common value, between the local user's send preference and
...
export class SendVideoController {
     ...
     *
     * @param {VideoAPIConference} conference - the conference instance for which the new instance will be managing
    ...
    /**
     * Handles the {@link VideoAPIConferenceEvents.MEDIA_SESSION_STARTED}, that is when the conference creates new media
