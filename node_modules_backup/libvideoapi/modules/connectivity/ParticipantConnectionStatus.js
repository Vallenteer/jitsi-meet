 ...
 * VideoAPIConferenceEvents.PARTICIPANT_CONN_STATUS_CHANGED events.
 */
export default class ParticipantConnectionStatusHandler {
     ...
     * @param {VideoAPIConference} conference parent conference instance
    ...
    constructor(rtc, conference, options) {
         ...
         * (as it might be different than the one stored in VideoAPIParticipant).
         ...
         *       implemented in VideoAPILocalTrack by extending the event to
    ...
    init() {
        ...
        this.conference.on(VideoAPIConferenceEvents.P2P_STATUS, this._onP2PStatus);

        // Used to send analytics events for the participant that left the call.
        this._onUserLeft = this.onUserLeft.bind(this);
        this.conference.on(VideoAPIConferenceEvents.USER_LEFT, this._onUserLeft);
        ...
        if (browser.supportsVideoMuteOnConnInterrupted()) {
            ...
            this.conference.on(
                VideoAPIConferenceEvents.TRACK_ADDED,
                this._onRemoteTrackAdded);

            this._onRemoteTrackRemoved = this.onRemoteTrackRemoved.bind(this);
            this.conference.on(
                VideoAPIConferenceEvents.TRACK_REMOVED,
                this._onRemoteTrackRemoved);

            // Listened which will be bound to VideoAPIRemoteTrack to listen for
        ...
        this.conference.on(
            VideoAPIConferenceEvents.LAST_N_ENDPOINTS_CHANGED,
    ...
    dispose() {
        ...
        this.conference.off(
            VideoAPIConferenceEvents.P2P_STATUS, this._onP2PStatus);

        this.conference.off(
            VideoAPIConferenceEvents.USER_LEFT, this._onUserLeft);
     ...
     * @param {VideoAPIParticipant} participant
     * @param newStatus
     */
    _changeConnectionStatus(participant, newStatus) {
        if (participant.getConnectionStatus() !== newStatus) {
            ...
            this.conference.eventEmitter.emit(
                VideoAPIConferenceEvents.PARTICIPANT_CONN_STATUS_CHANGED,
    ...
    /**
     * Bind signalling mute event listeners for video {VideoAPIRemoteTrack} when
     * a new one is added to the conference.
     *
     * @param {VideoAPITrack} remoteTrack - The {VideoAPITrack} which is being added to
     * the conference.
     */
    onRemoteTrackAdded(remoteTrack) {
        if (!remoteTrack.isLocal()
            ...
            remoteTrack.on(
                ...
                this._onSignallingMuteChanged);
            remoteTrack.on(
                VideoAPITrackEvents.TRACK_VIDEOTYPE_CHANGED,
     ...
     *
     * @param {VideoAPIRemoteTrack} remoteTrack - The remote track which is being
     ...
     * @param {VideoAPIParticipant} participant - The participant.
     ...
     *
     * @param {VideoAPIRemoteTrack} track - The video track for which 'onmute' event
     * will be processed.
     */
     ...
     *
     * @param {VideoAPIRemoteTrack} track - The video track for which 'onunmute'
     ...
     *
     * @param {VideoAPIRemoteTrack} track - The remote video track for which
     ...
     * changing.
     * @param {VideoAPIRemoteTrack} track - The track.
