...
class RTCUtils extends Listenable {
    ...
    * @returns {Promise} Returns a media stream on success or a VideoAPITrackError
    * on failure.
    **/
        ...
        return new Promise((resolve, reject) => {
            ...
            if (typeof timeout === 'number' && !isNaN(timeout) && timeout > 0) {
                gumTimeout = setTimeout(() => {
                    ...
                    reject(new VideoAPITrackError(VideoAPITrackErrors.TIMEOUT));
                }, timeout);
            }
            ...
            navigator.mediaDevices.getUserMedia(constraints)
                ...
                .catch(error => {
                    ...
                    const jitsiError = new VideoAPITrackError(error, constraints, umDevices);
                    ...
                    if (jitsiError.name === VideoAPITrackErrors.PERMISSION_DENIED) {
     ...
     * @param {Object} options.desktopSharingFrameRate.min - Minimum fps
     * @param {Object} options.desktopSharingFrameRate.max - Maximum fps
     * @returns {*} Promise object that will receive the new VideoAPITracks
     */
     ...
     * @returns {*} Promise object that will receive the new VideoAPITracks on
     * success or a VideoAPITrackError on failure.
     */
            ...
            .then(avStream => {
                ...
                if (missingTracks.length) {
                    ...
                    return this.getUserMediaWithConstraints(
                        ...
                        .then(() => Promise.reject(new VideoAPITrackError(
                            { name: 'UnknownError' },
    ...
    newObtainAudioAndVideoPermissions(options) {
        ...
        const maybeRequestDesktopDevice = function() {
            ...
            if (desktopSharingSourceDevice) {
                ...
                if (!matchingDevice) {
                    return Promise.reject(new VideoAPITrackError(
    ...
    return function(element, stream) {
        ...
        if (stream
            ...
            element.setSinkId(rtcUtils.getAudioOutputDevice())
                .catch(function(ex) {
                    const err
                        = new VideoAPITrackError(ex, null, [ 'audiooutput' ]);
