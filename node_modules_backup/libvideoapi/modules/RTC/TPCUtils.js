...
export class TPCUtils {
    ...
    /**
    * Adds {@link VideoAPILocalTrack} to the WebRTC peerconnection for the first time.
    * @param {VideoAPILocalTrack} track - track to be added to the peerconnection.
    ...
    */
     ...
     * @param {VideoAPILocalTrack} localTrack - track to be unmuted.
     ...
     * @param {VideoAPILocalTrack} localTrack - track to be removed.
     * @returns {Promise<void>} - resolved when done.
     */
     ...
     * @param {VideoAPILocalTrack} oldTrack - existing track on the sender that needs to be removed.
     * @param {VideoAPILocalTrack} newTrack - new track that needs to be added to the sender.
     * @returns {Promise<void>} - resolved when done.
     */
    replaceTrack(oldTrack, newTrack) {
        if (oldTrack && newTrack) {
            ...
            // replacing camera when video muted or replacing mic when audio muted. These VideoAPILocalTracks
    ...
    */
     ...
     * @param {VideoAPILocalTrack} track - the current track in use for which
