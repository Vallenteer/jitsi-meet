...
} from '../../VideoAPITrackErrors';
import {
    LOCAL_TRACK_STOPPED,
    NO_DATA_FROM_SOURCE,
    TRACK_MUTE_CHANGED
} from '../../VideoAPITrackEvents';
...
import VideoAPITrack from './VideoAPITrack';
 ...
 * One <tt>VideoAPILocalTrack</tt> corresponds to one WebRTC MediaStreamTrack.
 */
export default class VideoAPILocalTrack extends VideoAPITrack {
    /**
     * Constructs new VideoAPILocalTrack instance.
     *
     * @constructor
     ...
     * VideoAPIRemoteTrack
     * @param trackInfo.mediaType the MediaType of the VideoAPIRemoteTrack
     * @param trackInfo.videoType the VideoType of the VideoAPIRemoteTrack
    ...
    constructor({
        ...
        /**
         * The facing mode of the camera from which this VideoAPILocalTrack
    ...
    /**
     * Returns true if no data from source events are enabled for this VideoAPILocalTrack and false otherwise.
     *
     * @returns {boolean} - True if no data from source events are enabled for this VideoAPILocalTrack and false otherwise.
     */
    ...
    /**
     * Sets the stream property of VideoAPILocalTrack object and sets all stored
     * handlers to it.
     *
    ...
    setEffect(effect) {
        ...
        // TODO: Create new JingleSessionPC method for replacing a stream in VideoAPILocalTrack without offer answer.
    ...
    _setMuted(muted) {
        ...
        if (this.disposed) {
            return Promise.reject(new VideoAPITrackError(TRACK_IS_DISPOSED));
        }
        ...
        if (this.isAudioTrack()
            ...
            promise = promise.then(streamsInfo => {
                ...
                if (streamInfo) {
                    ...
                    throw new VideoAPITrackError(TRACK_NO_STREAM_FOUND);
                }
    ...
    /**
     * Sets the VideoAPIConference object associated with the track. This is temp
     * solution.
     *
     * @param conference the VideoAPIConference object
     */
     ...
     * Colibri endpoint id/MUC nickname in case of VideoAPI-meet.
     */
    getParticipantId() {
    ...
    stopStream() {
         ...
         * associated with this <tt>VideoAPITrack</tt> instance.
         *
         * @private
         * @type {boolean}
         */
