...
import VideoAPILocalTrack from './VideoAPILocalTrack';
...
function createLocalTracks(tracksInfo, options) {
    ...
    tracksInfo.forEach(trackInfo => {
        ...
        const localTrack = new VideoAPILocalTrack({
            ...trackInfo,
            deviceId,
...
/**
 * Creates {@code VideoAPILocalTrack} instances from the passed in meta information
 * about MedieaTracks.
 *
...
function _newCreateLocalTracks(mediaStreamMetaData = []) {
    return mediaStreamMetaData.map(metaData => {
        ...
        // FIXME Move rtcTrackIdCounter to a static method in VideoAPILocalTrack
        // so RTC does not need to handle ID management. This move would be
        // safer to do once the old createLocalTracks is removed.
        rtcTrackIdCounter = safeCounterIncrement(rtcTrackIdCounter);

        return new VideoAPILocalTrack({
            deviceId,
            facingMode,
...
export default class RTC extends Listenable {
     ...
     * @returns {Array<VideoAPILocalTrack>}
     */
     ...
     * @returns {VideoAPILocalTrack|undefined}
     */
    getLocalVideoTrack() {
