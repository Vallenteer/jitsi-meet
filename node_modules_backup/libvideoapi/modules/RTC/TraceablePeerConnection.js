...
import VideoAPIRemoteTrack from './VideoAPIRemoteTrack';
...
export default function TraceablePeerConnection(
     ...
     * @type {Map<string, Map<MediaType, VideoAPIRemoteTrack>>}
     */
    this.remoteTracks = new Map();

    /**
     * A map which stores local tracks mapped by {@link VideoAPILocalTrack.rtcId}
     * @type {Map<number, VideoAPILocalTrack>}
     */
 ...
 * @param {MediaType} [mediaType]
 * @return {Array<VideoAPILocalTrack>}
 */
 ...
 *
 * @returns {VideoAPILocalTrack|undefined} - local video track.
 */
 ...
 * @return {Array<VideoAPIRemoteTrack>}
 */
...
/**
 * Tries to find {@link VideoAPITrack} for given SSRC number. It will search both
 * local and remote tracks bound to this instance.
 * @param {number} ssrc
 * @return {VideoAPITrack|null}
 */
...
/**
 * Tries to find SSRC number for given {@link VideoAPITrack} id. It will search
...
/**
 * Initializes a new VideoAPIRemoteTrack instance with the data provided by
 ...
 * @return {VideoAPIRemoteTrack|undefined} the track's instance or
...
/**
 * Removes all VideoAPIRemoteTracks associated with given MUC nickname
 * (resource part of the JID). Returns array of removed tracks.
 *
 * @param {string} owner - The resource part of the MUC JID.
 * @returns {VideoAPIRemoteTrack[]}
 */
...
/**
 * Removes and disposes given <tt>VideoAPIRemoteTrack</tt> instance. Emits
 * {@link RTCEvents.REMOTE_TRACK_REMOVED}.
 * @param {VideoAPIRemoteTrack} toBeRemoved
 */
...
/**
 * Removes and disposes <tt>VideoAPIRemoteTrack</tt> identified by given stream and
 * track ids.
 *
 * @param {string} streamId the media stream id as defined by the WebRTC
 * @param {string} trackId the media track id as defined by the WebRTC
 * @returns {VideoAPIRemoteTrack|undefined} the track which has been removed or
...
/**
 *
 * @param {VideoAPILocalTrack} localTrack
 */
 ...
 *
 * @param {VideoAPILocalTrack|VideoAPIRemoteTrack} track - The track to be checked.
 * @returns {boolean}
 */
...
/**
 * Add {@link VideoAPILocalTrack} to this TPC.
 ...
 * @param {VideoAPILocalTrack} track the track to be added as part of the unmute
 * operation
 ...
 * @param {VideoAPILocalTrack} localTrack the track to be removed from this TPC.
 *
 ...
 * <tt>oldTrack</tt>
 *
 * @param {VideoAPILocalTrack|null} oldTrack - The current track in use to be
 * replaced
 * @param {VideoAPILocalTrack|null} newTrack - The new track to use
 ...
 * @param {VideoAPILocalTrack} localTrack the local track to be remove as part of
 * the mute operation.
 * @return {Promise<boolean>} Promise that resolves to true if the underlying PeerConnection's
 * state has changed and renegotiation is required, false if no renegotiation is needed or
 * Promise is rejected when something goes wrong.
 ...
 * @param {VideoAPILocalTrack} localTrack - the local track whose
