...
/**
 * Media devices utilities for VideoAPI.
 */
class VideoAPIMediaDevices {
    /**
     * Initializes a {@code VideoAPIMediaDevices} object. There will be a single
        ...
        RTC.addListener(
            ...
            devices =>
                this._eventEmitter.emit(
                    VideoAPIMediaDevicesEvents.DEVICE_LIST_CHANGED,
                    devices));
        RTC.addListener(
    ...
    _handlePermissionsChange(permissions) {
        ...
        if (hasPermissionsChanged) {
            ...
            this._eventEmitter.emit(VideoAPIMediaDevicesEvents.PERMISSIONS_CHANGED, this._permissions);
...
export default new VideoAPIMediaDevices();
